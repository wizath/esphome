...
#define LAN865X_OA_CONFIG0_RECV_FRAME_ALIGN_ANY \
  (0x0)  // Receive Ethernet frames may begin at any word of any receive data block
#define LAN865X_OA_CONFIG0_RECV_FRAME_ALIGN_ZERO \
  (0x1)  // Receive Ethernet frames will begin only at the first word of the receive data payload in any data block
#define LAN865X_OA_CONFIG0_RECV_FRAME_ALIGN_ZERO_CS \
  (0x2)  // Receive Ethernet frames only begin in the first word of the first receive data block payload following
         // assertion

#define LAN865X_OA_CONFIG0_TRANSMIT_CREDIT_THRESHOLD_1_BLK \
  (0x0)  // IRQ_N will be asserted when at least 1 data block available
#define LAN865X_OA_CONFIG0_TRANSMIT_CREDIT_THRESHOLD_4_BLK \
  (0x1)  // IRQ_N will be asserted when at least 4 data blocks available
#define LAN865X_OA_CONFIG0_TRANSMIT_CREDIT_THRESHOLD_8_BLK \
  (0x2)  // IRQ_N will be asserted when at least 8 data blocks available
#define LAN865X_OA_CONFIG0_TRANSMIT_CREDIT_THRESHOLD_16_BLK \
  (0x3)  // IRQ_N will be asserted when at least 16 data blocks available
