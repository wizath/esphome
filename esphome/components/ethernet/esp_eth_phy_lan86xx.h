...
typedef enum {
  ...
  LAN86XX_ETH_CMD_S_BURST_TIMER, /*!< Set time after transmission during which node is allowed to transmit more packets
                                    in incriments of 100ns */
  LAN86XX_ETH_CMD_G_BURST_TIMER, /*!< Get time after transmission during which node is allowed to transmit more packets
                                    in incriments of 100ns */
