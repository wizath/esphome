...
uint8_t MMC5983Component::read_register(uint8_t reg) {
...
void MMC5983Component::write_register(uint8_t reg, uint8_t value) {
...
uint32_t MMC5983Component::get_measurement_y() {
...
uint32_t MMC5983Component::get_measurement_z() {
