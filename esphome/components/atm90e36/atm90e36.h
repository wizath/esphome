...
class ATM90E36Component : public PollingComponent,
 ...
 public:
  ...
  // void set_total_active_power_sensor(int phase, sensor::Sensor *obj) { this->phase_[phase].total_active_power_sensor_ = obj; }
  // void set_total_reactive_power_sensor(int phase, sensor::Sensor *obj) { this->phase_[phase].total_reactive_power_sensor_ = obj; }
  // void set_total_apparent_power_sensor(int phase, sensor::Sensor *obj) { this->phase_[phase].total_apparent_power_sensor_ = obj; }
 ...
 protected:
  ...
  // float get_total_active_power_();
  // float get_total_reactive_power_();
  // float get_total_apparent_power_();
  ...
  struct ATM90E36Phase {
    ...
    // float total_active_power_{0};
    // float total_reactive_power_{0};
    // float total_apparent_power_{0};
