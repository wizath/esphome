...
/* POWER & P.F. REGISTERS */
static const uint16_t ATM90E36_REGISTER_PMEANT = 0xB0;   // Potencia Media Total (P)
static const uint16_t ATM90E36_REGISTER_PMEAN = 0xB1;    // Registro Base de Potencia Media (P)
static const uint16_t ATM90E36_REGISTER_PMEANA = 0xB1;   // Potencia Media A (P)
static const uint16_t ATM90E36_REGISTER_PMEANB = 0xB2;   // Potencia Media B (P)
static const uint16_t ATM90E36_REGISTER_PMEANC = 0xB3;   // Potencia Media C (P)
static const uint16_t ATM90E36_REGISTER_QMEANT = 0xB4;   // Potencia Media Total (Q)
static const uint16_t ATM90E36_REGISTER_QMEAN = 0xB5;    // Registro Base de Potencia Media (Q)
static const uint16_t ATM90E36_REGISTER_QMEANA = 0xB5;   // Potencia Media A (Q)
static const uint16_t ATM90E36_REGISTER_QMEANB = 0xB6;   // Potencia Media B (Q)
static const uint16_t ATM90E36_REGISTER_QMEANC = 0xB7;   // Potencia Media C (Q)
static const uint16_t ATM90E36_REGISTER_SMEANT = 0xB8;   // Potencia Media Total (S)
static const uint16_t ATM90E36_REGISTER_SMEANA = 0xB9;   // Potencia Media A (S)
static const uint16_t ATM90E36_REGISTER_SMEANB = 0xBA;   // Potencia Media B (S)
static const uint16_t ATM90E36_REGISTER_SMEANC = 0xBB;   // Potencia Media C (S)
static const uint16_t ATM90E36_REGISTER_PFMEANT = 0xBC;  // Factor de Potencia Medio
static const uint16_t ATM90E36_REGISTER_PFMEAN = 0xBD;   // Registro Base de Factor de Potencia
static const uint16_t ATM90E36_REGISTER_PFMEANA = 0xBD;  // Factor de Potencia A
static const uint16_t ATM90E36_REGISTER_PFMEANB = 0xBE;  // Factor de Potencia B
static const uint16_t ATM90E36_REGISTER_PFMEANC = 0xBF;  // Factor de Potencia C
